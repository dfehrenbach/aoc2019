...
(def puzzle-input (slurp "resources/day12/input.txt"))
...
(comment
  (def test1-input (slurp "resources/day12/test.txt"))
  (def test2-input (slurp "resources/day12/test2.txt"))
  (def test3-input (slurp "resources/day12/test3.txt"))
